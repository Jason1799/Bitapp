                ...
                {subTab === "config" ? (
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 h-full">
                        ...
                        <div className="flex flex-col gap-6 h-full min-h-0">
                            <Card className="border-none shadow-md bg-white/90 backdrop-blur-sm h-full flex flex-col overflow-hidden">
                                <CardHeader className="border-b bg-gray-50/50 pb-4 shrink-0">
                                    <div className="flex items-center gap-2">
                                        <Settings className="w-5 h-5 text-blue-600" />
                                        <CardTitle className="text-lg">API Configuration</CardTitle>
                                    </div>
                                </CardHeader>
                                <CardContent className="flex-1 flex flex-col gap-5 pt-6 overflow-y-auto">
                        ...
                        <div className="flex flex-col gap-6 h-full min-h-0">
                            <Card className="border-none shadow-md bg-white/90 backdrop-blur-sm h-full flex flex-col overflow-hidden">
                                ...
                                <CardContent className="flex-1 flex flex-col gap-4 pt-6 relative overflow-hidden">
                                    ...
                                    <div className="bg-yellow-50 border border-yellow-100 rounded p-3 text-xs text-yellow-800 shrink-0">
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 h-full">
                        ...
                        <Card className="border-none shadow-md bg-white/90 backdrop-blur-sm flex flex-col h-full overflow-hidden">
                            <CardHeader className="border-b bg-gray-50/50 pb-4 shrink-0">
                            ...
                            <CardContent className="flex-1 flex flex-col gap-4 pt-4 overflow-hidden">
                                <Textarea
                                    className="flex-1 font-mono text-xs bg-gray-50 leading-relaxed resize-none"
                                    value={promptText}
                                ...
                                <div className="bg-blue-50 border border-blue-100 rounded p-3 text-xs text-blue-800 space-y-1 shrink-0">
                                    <strong>使用说明：</strong>
